        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <nav class="navbar navbar-dark bg-dark" style="height:60px; width:1370px" ;>
                    <h1 style="color:white; margin-left:30px;">Courses History</h1>
                </nav>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View Test Details'), ['controller'=> 'users', 'action' => 'testdetails', $course->id], ['class' => 'btn bg-gradient-primary w-20 my-4 mb-2']) ?>
