...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-10">
                <br><br>
                <div class="navbar navbar-dark bg-dark" style="height:60px; width:1370px" ;>
            ...
            ?>
                        <div class="col-auto my-auto">
                            <div class="h-100">
                                <h2 class="mb-1" style="color:white;margin-top:5px;">
                                <i><b>Welcome,
                                    <?php echo $show->first_name; ?></b></i>
                                </h2>
                            </div>
                        </div>
                        <br>
                ...
                <h3><i><b>Total Number of Courses: <?php echo $course ?></b></i></h3> 
