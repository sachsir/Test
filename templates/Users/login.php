        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h2 class="section-title bg-white text-start text-primary pe-3">Login</h2>
                    ...
                    <div class="users form">
                        ...
                        <fieldset>
                            <br>
                            <h3 class=" bg-white text-start text-primary pe-3">Please enter your Username and Password
                            </h3>
                            <h2 class=" bg-white text-start text-primary pe-3">
                        ...
                        <?= $this->Form->submit('Login',['id'=>'login-btn']); ?>
                        <?= $this->Form->end() ?>
                        <br>

                        <?= $this->Html->link(__('Forgot Password'), ['controller'=> 'Users', 'action'=>'forgot',], ['class' => 'side-nav-item','id'=>'forgot-btn']) ?>
