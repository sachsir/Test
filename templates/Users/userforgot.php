        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h2 class="section-title bg-white text-start text-primary pe-3">Forgot Password</h2>
                    ...
                    <div class="users form">
                        ...
                        <fieldset>
                            <br>
                            <h4 class=" bg-white text-start text-primary pe-3">Please enter your Email to reset your
                                Password</h4>
                            <br>
                        ...
                        <?= $this->Form->submit('Send Mail',['id'=>'login-btn']); ?>
                        <?= $this->Form->end() ?>
                        <br>
