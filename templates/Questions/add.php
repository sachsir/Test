          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            <fieldset>
                <legend><?= __('Add Question') ?></legend>
                   ...
                   <?php echo $this->Form->control('option_a',['required'=>false]); ?>
                   <?php echo $this->Form->control('option_b',['required'=>false]); ?>
                   <?php echo $this->Form->control('option_c',['required'=>false]); ?>
                   <?php echo $this->Form->control('option_d',['required'=>false]); ?>
